...
import { Box, FormControlLabel, Checkbox, TextField, Grid, Typography, Button } from "@mui/material";
  ...
  return (
    <Box sx={{ width: "70%", m: "auto" }}>
      ...
      {ORG_KEY_NAMES.map((item, i) => {
        ...
        if (!item.checkBox) {
          return (
            <Box sx={{ width: 150, marginBottom: 5 }} key={i}>
              {item.keyName === "logoId" && (
                <Box>
                  ...
                  >
                    <img alt="Logo Preview" src={logoPreview} />
                  </AspectRatio>
                  <Button
                    component="label"
                    role={undefined}
